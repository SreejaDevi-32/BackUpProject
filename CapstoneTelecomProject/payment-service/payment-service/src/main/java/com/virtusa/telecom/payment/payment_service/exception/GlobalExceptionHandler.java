package com.virtusa.telecom.payment.payment_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleResourceNotFound(PaymentNotFoundException ex,HttpServletRequest request) {
